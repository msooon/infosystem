...
mkdir -p $infosystem/pub_dbs  2> /dev/null
mkdir -p $backup 2> /dev/null

#pub_dbs 
sqlite3 $database < $infosystem/infosystem.sql
cp $database $infosystem/template.db
sqlite3 $infosystem/template.db "delete from infos;"
